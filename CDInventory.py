...
#defining global variables for ID, Title and Artist to pass information between functions without shadowing variables
strIDGlobal = ''
strTitleGlobal = ''
strArtistGlobal = ''
...
class DataProcessor:
    ...
    def append_cd_inventory_memory_list(strID, strTitle, strArtist, table):
        ...
        Args:
            strID (string): Requested ID of CD the user would like to add
...
class FileProcessor:
    ...
    def write_file(file_name, table):
        ...
        Casts each dictionary into a string, adds a new line at the end of each string and overrides any data in file.
...
class IO:
    ...
    def cd_user_input():
        ...
        Returns:
            strID, strTitle, strArtist (tuple): Returns tuple with the 3 variables: ID, Title and Artist
